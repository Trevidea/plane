...
MEDIA_LIBRARY_FILE_SIZE_LIMIT = int(os.environ.get("MEDIA_LIBRARY_FILE_SIZE_LIMIT", 1073741824))
...
SERVICE_GATEWAY_TIMEZONE = os.environ.get("SERVICE_GATEWAY_TIMEZONE", "Asia/Kolkata")
try:
