...
MEDIA_LIBRARY_FILE_SIZE_LIMIT = int(os.environ.get("MEDIA_LIBRARY_FILE_SIZE_LIMIT", 5368709120))
MEDIA_LIBRARY_HLS_SIZE_THRESHOLD = int(os.environ.get("MEDIA_LIBRARY_HLS_SIZE_THRESHOLD", 104857600))
MEDIA_LIBRARY_STREAM_CHUNK_BYTES = int(os.environ.get("MEDIA_LIBRARY_STREAM_CHUNK_BYTES", 4 * 1024 * 1024))
MEDIA_LIBRARY_THUMBNAIL_MAX_BYTES = int(os.environ.get("MEDIA_LIBRARY_THUMBNAIL_MAX_BYTES", 51200))
MEDIA_TRANSCODE_SERVICE_URL = os.environ.get("MEDIA_TRANSCODE_SERVICE_URL", "http://thumbnail-service:5000")
MEDIA_TRANSCODE_INTERNAL_API_TOKEN = os.environ.get("MEDIA_TRANSCODE_INTERNAL_API_TOKEN", "")
MEDIA_TRANSCODE_REQUEST_TIMEOUT = float(os.environ.get("MEDIA_TRANSCODE_REQUEST_TIMEOUT", 10))
MEDIA_TRANSCODE_OUTPUT_BASE_URL = os.environ.get("MEDIA_TRANSCODE_OUTPUT_BASE_URL", "")
MEDIA_TRANSCODE_OUTPUT_ROOT = os.environ.get("MEDIA_TRANSCODE_OUTPUT_ROOT", "/data/transcoded")
...
DATA_UPLOAD_MAX_MEMORY_SIZE = max(FILE_SIZE_LIMIT, MEDIA_LIBRARY_FILE_SIZE_LIMIT)
...
COACH_SESSION_COOKIE_NAME = os.environ.get("COACH_SESSION_COOKIE_NAME", "coach-session-id")
COACH_SESSION_COOKIE_AGE = int(os.environ.get("COACH_SESSION_COOKIE_AGE", SESSION_COOKIE_AGE))
...
# Service Gateway Webhook Sync
SERVICE_GATEWAY_EVENT_API = os.environ.get("SERVICE_GATEWAY_EVENT_API", "")
SERVICE_GATEWAY_EVENT_SEND_API = os.environ.get("SERVICE_GATEWAY_EVENT_SEND_API", "")
SERVICE_GATEWAY_SCHEDULED_EVENT_API = os.environ.get("SERVICE_GATEWAY_SCHEDULED_EVENT_API", "")
SERVICE_GATEWAY_WEBHOOK_ENABLED = (
    os.environ.get("SERVICE_GATEWAY_WEBHOOK_ENABLED", "1" if SERVICE_GATEWAY_EVENT_API else "0") == "1"
)
SERVICE_GATEWAY_WEBHOOK_TIMEOUT = int(os.environ.get("SERVICE_GATEWAY_WEBHOOK_TIMEOUT", 30))
SERVICE_GATEWAY_TIMEZONE = os.environ.get("SERVICE_GATEWAY_TIMEZONE", "UTC")
try:
    SERVICE_GATEWAY_DEFAULT_TEAM_ID = int(os.environ.get("SERVICE_GATEWAY_DEFAULT_TEAM_ID", 0))
except (TypeError, ValueError):
    SERVICE_GATEWAY_DEFAULT_TEAM_ID = 0
