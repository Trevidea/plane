...
export const SgEventDetailsCard = ({
  ...
  <section className={cn(SURFACE_CLASS, "overflow-hidden")}>
    <div className="px-4 pb-1 pt-2 text-sm font-semibold text-custom-text-100">Event details</div>
    <div className="grid gap-x-4 gap-y-2 px-4 pb-2 pt-1 md:grid-cols-[minmax(180px,0.9fr)_minmax(260px,1.3fr)_minmax(120px,0.55fr)]">
